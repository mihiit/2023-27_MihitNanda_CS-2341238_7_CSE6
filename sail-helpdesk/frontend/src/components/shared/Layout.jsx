  ...
  return (
    <>
      ...
      <aside
        ...
        `}
        style={{
          background: 'linear-gradient(180deg, #1B2A6B 0%, #16215A 100%)'
        }}
      >
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-white/10">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Larger SAIL logo */}
            <div className="bg-white rounded-lg w-14 h-14 flex items-center justify-center flex-shrink-0 shadow-sm overflow-hidden">
              <img
                src="/sail-logo.png"
                alt="SAIL"
            ...
            <div>
              ...
              <p className="text-white/40 text-[10px] leading-tight tracking-wide">
                IT HELPDESK
              </p>
            </div>
        ...
        {/* User chip */}
        <div
          className="mx-3 mt-3 mb-1 px-3 py-2.5 rounded-lg border border-white/10"
          style={{
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        <ChevronDown
          size={14}
          className="text-[--text-light] group-hover:text-[--sail] transition-colors hidden sm:block"
        />
      </button>

      {open && (
        <div
          className="absolute right-0 top-11 w-52 bg-white rounded-xl border z-50 overflow-hidden fade-up"
          style={{
...
export function Topbar({ onMenuOpen, title, subtitle }) {
  ...
  return (
    <header
      className="bg-white steel-mesh px-4 lg:px-6 h-14 flex items-center gap-4 sticky top-0 z-20"
      style={{
        borderBottom: '1px solid var(--border-soft)',
    ...
    >
      ...
      <button
        onClick={onMenuOpen}
        className="lg:hidden p-1.5 rounded-lg border flex-shrink-0"
        style={{
